                                    ...
                                    <table id="datatable" class="table table-bordered table-striped table-hover table-dark">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>  
                                            ...
                                            <td><?php echo e($review->reviews); ?></td>
                                            <td><?php echo e($review->star); ?></td>
                                            <td>
                                                <img src="<?php echo asset('Uploads/'.$review->image); ?>" height="100" width="200"  />
                                            </td>
                                            
                                            <td>
  
                                                <a href=<?php echo e("deletereviews/".$review['id']); ?> onclick="return confirm('Are you sure to delete this record?')"
...
<?php /**PATH D:\laravel\cleaning_service\resources\views//AdminDashboard_Layout/review.blade.php ENDPATH**/ ?>