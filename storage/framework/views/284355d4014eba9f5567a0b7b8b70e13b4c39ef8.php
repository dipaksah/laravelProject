...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?php echo e('/customers'); ?>">Customers</a>
                    <a class="collapse-item" href="<?php echo e('/booked'); ?>">Orders</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e('/review'); ?>">
                <i class="fas fa-fw fa-table"></i>
                <span>Review</span></a>
        </li>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                   ...
                                   <div class="col-x1-6 col-lg-7">
                                    <form method="POST" action="<?php echo e(route('cleaneradd')); ?>"
                                    class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-1 mw-100 navbar-search">
                                    <?php echo csrf_field(); ?>
                                    <div class="input-group">
                                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control bg-light border-0 small" placeholder="cleaners name"
                                            aria-label="Search" aria-describedby="basic-addon2">
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-primary btn-user btn-block">
                                                <?php echo e(__('Add Cleaners')); ?>
                                            ...
                                            <table class="table table-bordered table-striped table-hover table-dark">
                                              ...
                                              <tbody>
                                                ...
                                                <tr>  
                                                    ...
                                                    <td><a href=<?php echo e("deletecleaner/".$result['id']); ?> onclick="return confirm('Are you sure to delete this record?')"
                                                        ...
                                                        <a href=""  
                                                            data-name="<?php echo e($result->name); ?>"
                                                            data-status="<?php echo e($result->status); ?>"
                                                            data-toggle="modal" data-target="#editModal"
                                                            onclick="changeRoute(<?php echo e(route('updatecleaner', $result->id)); ?>)"
                                                            data-url="<?php echo e(route('updatecleaner', $result->id)); ?>"
...
<?php /**PATH D:\laravel\cleaning_service\resources\views//AdminDashboard_Layout/admin_dashboard.blade.php ENDPATH**/ ?>