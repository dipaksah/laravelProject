...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="<?php echo e('admin_dashboard'); ?>">
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?php echo e('/services'); ?>">Services</a>
                    <a class="collapse-item" href="<?php echo e('/booked'); ?>">Booked</a>
                </div>
            </div>
        </li>
        ...
        <!-- Nav Item - Logout -->
        <li class="nav-item">
            <a class="nav-link" href="<?php echo e('logout'); ?>">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped table-hover table-dark">
                                      ...
                                      <tbody>
                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>  
                                                    <td><?php echo e($result->date); ?></td>
                                                    <td><?php echo e($result->time1From); ?></td>
                                                    <td><?php echo e($result->time2To); ?></td>
                                                    <td><?php echo e($result->location); ?></td>
                                                    <td><?php echo e($result->service); ?></td>
                                                    <td><?php echo e($result->NoFcleaner); ?></td>
                                                    <td>
                                                        <?php echo e($result->Total_Rate); ?>
                                                    ...
                                                    <td>
                                                        <a href="" type="button"
                                                        class="btn btn-primary"
                                                        data-toggle="modal" data-target="#reviewModal<?php echo e($result->id); ?>"
                                                        >Review !</a>
                                                    </td>

                                                    <div class="modal fade" id="reviewModal<?php echo e($result->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLable" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                           <div class="modal-content">
                                                               <div class="modal-header">
                                                                       ...
                                                                       <div class="row">
                                                                           <div class="col-75">
                                                                             <div class="container">
                                                                                     ...
                                                                                     <form method="POST" action="<?php echo e(route('review')); ?>" enctype="multipart/form-data" >
                                                                                       <?php echo csrf_field(); ?>
                                                                                       <input type="text" name="booking_id" value="<?php echo e($result->id); ?>" hidden >
...
<!-- Page level plugins -->
<script src="<?php echo e(asset('/customAuth/vendor/chart.js/Chart.min.js')); ?>"></script>

<!-- Page level custom scripts -->
<script src="<?php echo e(asset('/customAuth/js/demo/chart-area-demo.js')); ?>"></script>
<script src="<?php echo e(asset('/customAuth/js/demo/chart-pie-demo.js')); ?>"></script>

</body>

</html>
<?php /**PATH D:\laravel\cleaning_service\resources\views//UserDashboard/user_dashboard.blade.php ENDPATH**/ ?>